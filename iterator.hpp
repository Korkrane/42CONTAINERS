...
/*   Updated: 2021/10/05 17:53:59 by bahaas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    * @details Standard algorithms determine certain properties of the iterators passed
    * to them and the range they represent by using the members of the corresponding
    ...
    */
    ...
    public:
        ...
        template <class Iter>
        reverse_iterator(const reverse_iterator<Iter> &rev_it) : current(rev_it.base()) {} //copy / type-cast
